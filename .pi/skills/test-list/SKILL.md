...
Consult `.pi/skills/exact-coding-tcr/human-in-the-loop.md`. Apply the Test-List checkpoint for the active Autonomy
Level and wait for explicit approval when required; otherwise continue with the
EXACT Coding TCR workflow.
