...
Consult `.github/rules/human-in-the-loop.md`. If the current Autonomy Level includes a stop after Red phase,
...
Then apply the **Prediction Failure Recovery** procedure in `.github/rules/human-in-the-loop.md`. In every
