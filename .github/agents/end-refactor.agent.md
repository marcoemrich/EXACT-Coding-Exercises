---
name: end-refactor
description: Final metric-driven refactoring pass over the whole production tree. Runs ONCE after the last green cycle. Uses ESLint smells, SonarJS cognitive complexity, McCabe cyclomatic complexity and APP mass to drive one measured change at a time while keeping all tests green.
agents: []
---
