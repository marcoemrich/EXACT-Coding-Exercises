...
describe("Score Card: Cyclops", () => {
  ...
  it("should return 4 points for 2 Cyclops (je 2 Punkte)", () => {
    expect(scoreCyclopsCards(2)).toBe(4);
  });
  it("should return 6 points for 3 Cyclops (je 2 Punkte)", () => {
    expect(scoreCyclopsCards(3)).toBe(6);
  });
  it("should return 10 points for 5 Cyclops (je 2 Punkte)", () => {
